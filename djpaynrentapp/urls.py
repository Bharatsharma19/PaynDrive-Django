...
urlpatterns = [
    ...
    re_path(r'^api/display_category_icon/$',
            category_view.DisplayCategoryIcon),
    ...
    re_path(r'^api/subcategoryinterface',
            subcategory_view.SubCategoryInterface),
    ...
    re_path(r'^api/subcategorydisplaybyid',
            subcategory_view.DisplaySubCategorybyId),
    re_path(r'^api/editsubcategory', subcategory_view.EditSubCategory),
    re_path(r'^api/subcategoryicondisplay',
            subcategory_view.DisplaySubCategoryIcon),
    re_path(r'^api/savesubcategoryicon', subcategory_view.SubCategoryIconSave),
    re_path(r'^api/jsondisplaysubcategory',
            subcategory_view.DisplaySubCategoryJSON),
