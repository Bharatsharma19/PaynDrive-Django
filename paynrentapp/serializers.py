...
class SubCategorySerializers(serializers.ModelSerializer):
    class Meta:
        model = SubCategory
        fields = ('id', 'category_id', 'company_name',
                  'subcategory_name', 'description', 'icon')


class VehicleSerializers(serializers.ModelSerializer):
    class Meta:
        model = Vehicle
        fields = ('id', 'category_id', 'subcategory_id', 'model_year', 'variant', 'price', 'insured', 'registration_no',
                  'owner_name', 'mobile_no', 'color', 'fuel_type', 'no_of_seats', 'transmission_type', 'icon')
